...
document.getElementById('presetSelector').addEventListener('change', function() {
  const presets = {
  goldenSpiral: { scale: 25, nodes: 50, rotation: 0, layers: 10, layerRatio: 6, verticalMirror: true, horizontalMirror: false, strokeColor: '#FFD700', lineWidth: 2, opacity: 0.9, spiralType: 'logarithmic', backgroundColor: '#111111', verticalColor: '#FF4500', horizontalColor: '#FFFF00', bothColor: '#FFFFFF', gradientStroke: true, dashEffect: false, autoRotate: false, curvedLines: true },
  denseMirror: { scale: 15, nodes: 50, rotation: 0, layers: 20, layerRatio: 5.5, verticalMirror: true, horizontalMirror: true, strokeColor: '#00FF00', lineWidth: 3, opacity: 1, spiralType: 'linear', backgroundColor: '#111111', verticalColor: '#FF00FF', horizontalColor: '#FFFF00', bothColor: '#00FF00', gradientStroke: false, dashEffect: true, autoRotate: false, curvedLines: false },
  ...
  starBurst: { scale: 25, nodes: 50, rotation: 0, layers: 5, layerRatio: 6.5, verticalMirror: true, horizontalMirror: true, strokeColor: '#FF69B4', lineWidth: 2, opacity: 1, spiralType: 'linear', backgroundColor: '#111111', verticalColor: '#FF00FF', horizontalColor: '#FFFF00', bothColor: '#FFA500', gradientStroke: true, dashEffect: false, autoRotate: true, curvedLines: false },
  ...
  kaleidoscope: { scale: 20, nodes: 50, rotation: 0, layers: 8, layerRatio: 6, verticalMirror: true, horizontalMirror: true, strokeColor: '#FF1493', lineWidth: 3, opacity: 1, spiralType: 'linear', backgroundColor: '#111111', verticalColor: '#FF00FF', horizontalColor: '#FFFF00', bothColor: '#00FFFF', gradientStroke: false, dashEffect: true, autoRotate: true, curvedLines: false },
  cosmicWave: { scale: 40, nodes: 45, rotation: 0, layers: 10, layerRatio: 5.8, verticalMirror: false, horizontalMirror: true, strokeColor: '#00B7EB', lineWidth: 2, opacity: 0.9, spiralType: 'logarithmic', backgroundColor: '#0A1F44', verticalColor: '#FF00FF', horizontalColor: '#00CED1', bothColor: '#FFFFFF', gradientStroke: true, dashEffect: false, autoRotate: true, curvedLines: true },
  fractalBloom: { scale: 15, nodes: 50, rotation: 0, layers: 15, layerRatio: 6.2, verticalMirror: true, horizontalMirror: true, strokeColor: '#FF4500', lineWidth: 1, opacity: 0.7, spiralType: 'linear', backgroundColor: '#222222', verticalColor: '#FFD700', horizontalColor: '#FF69B4', bothColor: '#FFFFFF', gradientStroke: false, dashEffect: false, autoRotate: false, curvedLines: true },
  crystalVortex: { scale: 25, nodes: 40, rotation: 0, layers: 6, layerRatio: 5.5, verticalMirror: true, horizontalMirror: false, strokeColor: '#00FFFF', lineWidth: 2, opacity: 0.85, spiralType: 'logarithmic', backgroundColor: '#0D1B2A', verticalColor: '#1E90FF', horizontalColor: '#FFFF00', bothColor: '#FFFFFF', gradientStroke: true, dashEffect: false, autoRotate: false, curvedLines: true },
  galacticPulse: { scale: 50, nodes: 50, rotation: 0, layers: 8, layerRatio: 6.5, verticalMirror: false, horizontalMirror: true, strokeColor: '#FF00FF', lineWidth: 3, opacity: 1, spiralType: 'linear', backgroundColor: '#000033', verticalColor: '#FF00FF', horizontalColor: '#00FF00', bothColor: '#FFFFFF', gradientStroke: true, dashEffect: false, autoRotate: true, curvedLines: false },
  etherealRings: { scale: 30, nodes: 30, rotation: 0, layers: 12, layerRatio: 5.2, verticalMirror: true, horizontalMirror: true, strokeColor: '#E6E6FA', lineWidth: 1, opacity: 0.5, spiralType: 'logarithmic', backgroundColor: '#2A2A40', verticalColor: '#D8BFD8', horizontalColor: '#98FB98', bothColor: '#FFFFFF', gradientStroke: false, dashEffect: true, autoRotate: false, curvedLines: true }
};
