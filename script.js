...
document.getElementById('presetSelector').addEventListener('change', function() {
  ...
  violetBloom: { scale: 7, nodes: 50, rotation: 0, layers: 15, layerRatio: 4.2, verticalMirror: true, horizontalMirror: true, strokeColor: '#FF00F7', lineWidth: 4, opacity: 0.8, spiralType: 'linear', backgroundColor: '#000000', verticalColor: '#FF00F7', horizontalColor: '#000000', bothColor: '#6E00DB', gradientStroke: false, dashEffect: false, autoRotate: true, curvedLines: false },
  ...
  solarFlareBlossom: { scale: 15, nodes: 50, rotation: 0, layers: 20, layerRatio: 5.4, verticalMirror: true, horizontalMirror: false, strokeColor: '#FF4500', lineWidth: 3, opacity: 0.9, spiralType: 'linear', backgroundColor: '#000000', verticalColor: '#FFD700', horizontalColor: '#FFFF00', bothColor: '#FFA500', gradientStroke: true, dashEffect: false, autoRotate: true, curvedLines: false },
